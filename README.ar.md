...
### تحويل الصورة إلى خط متصل تحمله حقول لونية شفافة
...
> علاقة واحدة · خط رفيع متصل · ٢–٤ حقول لونية · حافة مائية · فراغ يتنفس

تُختزل الصورة إلى علاقة واحدة مميزة ترسمها خطوط قليلة ذات توقف طبيعي. وتتبع حقول لونية شفافة مستخرجة من المصدر، وعددها من اثنين إلى أربعة، المحيط والحركة والفراغ السلبي والثقل العاطفي بدلاً من أن تكون زينة مستقلة.
...
- **الارتباط بالمصدر:** تحويل الصورة إلى خط متصل تحمله حقول لونية شفافة
- **بصمة الأسلوب:** علاقة واحدة · خط رفيع متصل · ٢–٤ حقول لونية · حافة مائية · فراغ يتنفس
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-036`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/036-source.md) · [توجيه الإنتاج الإنجليزي](references/xxd-panel-036-prompt.en.md) · [توجيه الإنتاج الصيني](references/xxd-panel-036-prompt.zh-CN.md)
...
<div align="center" dir="rtl"><strong>يحفظ الخط قابلية التعرّف، ويحمل اللون الشعور المتبقي.</strong></div>
